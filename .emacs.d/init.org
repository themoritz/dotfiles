...
#+BEGIN_SRC emacs-lisp
  ...
  ;; See https://github.com/abo-abo/swiper#frequently-asked-questions
  (setq ivy-use-selectable-prompt t)

  ;; This fixes an issue where I would get `error code 2` when searching two words.
  ;; see  https://github.com/raxod502/prescient.el/issues/43
